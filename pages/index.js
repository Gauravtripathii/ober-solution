...
import { getProfileFromApi } from "../utils/api";
          ...
          <div className="hero-started">
            ...
            <div className="content">
              <div className="titles">
                <div className="subtitle">{profile.user.about.title}</div>
                <h2 className="title">{profile.user.about.name}</h2>
              </div>
              <div className="description">
                <p>{profile.user.about.subTitle}</p>
            ...
            <div className="info-list">
              <ul>
                <li>
                  Born in <strong>{profile.user.about.address}</strong>
                </li>
                <li>
                  Experience <strong>{profile.user.about.exp_year} Years</strong>
                </li>
                <li>
          ...
          <div className="row row-custom">
            ...
            <div className="col-xs-12 col-sm-12 col-md-9 col-lg-9 vertical-line">
              ...
              <div className="profile-box">
                <div className="text">
                  <p>
                    My name is {profile.user.about.name}. {profile.user.about.subTitle}.
                  </p>
                  <p>
